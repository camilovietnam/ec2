...
/* Smarty version 3.1.36, created on 2020-12-29 13:45:05
  from '/var/www/html/data/Smarty/templates/admin/main_frame.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_5feab4515de9e6_09620359',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0d8a3ea0810dea0a80b94442eef65f70c609b11e' => 
    array (
      0 => '/var/www/html/data/Smarty/templates/admin/main_frame.tpl',
      1 => 1608045649,
      2 => 'file',
    ),
  ),
...
function content_5feab4515de9e6_09620359 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/var/www/html/data/smarty_extends/modifier.script_escape.php','function'=>'smarty_modifier_script_escape',),1=>array('file'=>'/var/www/html/data/smarty_extends/modifier.h.php','function'=>'smarty_modifier_h',),2=>array('file'=>'/var/www/html/data/vendor/smarty/smarty/libs/plugins/modifier.date_format.php','function'=>'smarty_modifier_date_format',),));
...
<?php echo '<script'; ?>
 type="text/javascript" src="<?php echo smarty_modifier_script_escape(@constant('ROOT_URLPATH'));?>
...
>
<title><?php echo smarty_modifier_script_escape(@constant('ADMIN_TITLE'));?>
</title>
...
<div id="header">
    <div id="header-contents">
        <div id="logo"><a href="<?php echo smarty_modifier_script_escape(@constant('ADMIN_HOME_URLPATH'));?>
...
img/header/logo.jpg" width="172" height="25" alt="EC-CUBE" /></a></div>
        <div id="site-check">
            ...
            <ul>
                <li><a href="<?php echo smarty_modifier_script_escape(@constant('HTTP_URL'));
echo smarty_modifier_script_escape(@constant('DIR_INDEX_PATH'));?>
" class="btn-tool-format" target="_blank"><span>SITE CHECK</span></a></li>
                <li><a href="<?php echo smarty_modifier_script_escape(@constant('ADMIN_LOGOUT_URLPATH'));?>
...
<div id="navi-wrap">
    <ul id="navi" class="clearfix">
        <li id="navi-basis" class="on_level1<?php if ($_smarty_tpl->tpl_vars['tpl_mainno']->value == "basis") {?> on<?php }?>">
            ...
            <?php $_smarty_tpl->_subTemplateRender(((string)@constant('TEMPLATE_ADMIN_REALDIR'))."basis/subnavi.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
        </li>
        <li id="navi-products" class="on_level1<?php if ($_smarty_tpl->tpl_vars['tpl_mainno']->value == "products") {?> on<?php }?>">
            <div><span>商品管理</span></div>
            <?php $_smarty_tpl->_subTemplateRender(((string)@constant('TEMPLATE_ADMIN_REALDIR'))."products/subnavi.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
        </li>
        <li id="navi-customer" class="on_level1<?php if ($_smarty_tpl->tpl_vars['tpl_mainno']->value == "customer") {?> on<?php }?>">
            <div><span>会員管理</span></div>
            <?php $_smarty_tpl->_subTemplateRender(((string)@constant('TEMPLATE_ADMIN_REALDIR'))."customer/subnavi.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
        </li>
        <li id="navi-order" class="on_level1<?php if ($_smarty_tpl->tpl_vars['tpl_mainno']->value == "order") {?> on<?php }?>">
            <div><span>受注管理</span></div>
            <?php $_smarty_tpl->_subTemplateRender(((string)@constant('TEMPLATE_ADMIN_REALDIR'))."order/subnavi.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
        </li>
        <li id="navi-total" class="on_level1<?php if ($_smarty_tpl->tpl_vars['tpl_mainno']->value == "total") {?> on<?php }?>">
            <div><span>売上集計</span></div>
            <?php $_smarty_tpl->_subTemplateRender(((string)@constant('TEMPLATE_ADMIN_REALDIR'))."total/subnavi.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
        </li>
        <li id="navi-mail" class="on_level1<?php if ($_smarty_tpl->tpl_vars['tpl_mainno']->value == "mail") {?> on<?php }?>">
            <div><span>メルマガ管理</span></div>
            <?php $_smarty_tpl->_subTemplateRender(((string)@constant('TEMPLATE_ADMIN_REALDIR'))."mail/subnavi.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
        </li>
        <li id="navi-contents" class="on_level1<?php if ($_smarty_tpl->tpl_vars['tpl_mainno']->value == "contents") {?> on<?php }?>">
            ...
            <?php $_smarty_tpl->_subTemplateRender(((string)@constant('TEMPLATE_ADMIN_REALDIR'))."contents/subnavi.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
        </li>
        <li id="navi-design" class="on_level1<?php if ($_smarty_tpl->tpl_vars['tpl_mainno']->value == "design") {?> on<?php }?>">
            <div><span>デザイン管理</span></div>
            <?php $_smarty_tpl->_subTemplateRender(((string)@constant('TEMPLATE_ADMIN_REALDIR'))."design/subnavi.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
        </li>
        <li id="navi-system" class="on_level1<?php if ($_smarty_tpl->tpl_vars['tpl_mainno']->value == "system") {?> on<?php }?>">
            <div><span>システム設定</span></div>
            <?php $_smarty_tpl->_subTemplateRender(((string)@constant('TEMPLATE_ADMIN_REALDIR'))."system/subnavi.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
        </li>
        <li id="navi-ownersstore" class="on_level1<?php if ($_smarty_tpl->tpl_vars['tpl_mainno']->value == "ownersstore") {?> on<?php }?>">
            ...
            <?php $_smarty_tpl->_subTemplateRender(((string)@constant('TEMPLATE_ADMIN_REALDIR'))."ownersstore/subnavi.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
        </li>
    </ul>
</div>
